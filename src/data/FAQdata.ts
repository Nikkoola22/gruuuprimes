...
export const faqData: FAQItem[] = [
  {
    id: 1001,
    question: "Ai-je droit à un temps partiel pour la naissance de mon enfant ?",
    answer: "Oui, tout agent a droit à un temps partiel de droit à l’occasion de la naissance ou de l’adoption d’un enfant, selon les modalités prévues par la collectivité (quotités possibles : 50%, 60%, 70%, 80%, 90%). La demande doit être faite auprès de la DRH et le droit est automatique jusqu’au 3e anniversaire de l’enfant.",
