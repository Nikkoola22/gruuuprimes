...
interface GennevilliersLogoProps extends React.SVGProps<SVGSVGElement> {
  className?: string;
  variant?: "blue" | "dark" | "white" | "monochrome";
}

export const GennevilliersLogo: React.FC<GennevilliersLogoProps> = ({
  ...
  const getFillClass = () => {
    switch (variant) {
      case "blue":
        return "text-[#0B3C5D] dark:text-blue-400";
      case "dark":
  ...
  return (
    <svg
      ...
      viewBox="0 0 559.8 235"
      className={`${getFillClass()} ${className}`}
      fill="currentColor"
      aria-label="Logo officiel Ville de Gennevilliers"
      {...props}
    >
      ...
      <path d="M386.9,155.4c0.2-0.5,0.6-1.7,0.8-2.1c0.2-0.2,0.9-0.8,1-1.1c0.1-0.2-0.1-0.7-0.1-0.8c0-0.5,0.1-1.8-0.1-2.2
        ...
        c0,0.3-0.5,1-0.5,1.3c0,0.5,1,1.2,0.4,2c-0.2,0.2-1,0.5-1.3,0.7" />
    </svg>
  );
};

export default GennevilliersLogo;
