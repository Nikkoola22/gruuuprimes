...
const ChifoumiRH = lazy(() => import("./ChifoumiRH.tsx"));
...
interface GameDef {
  id: "roulette" | "memory" | "quiz" | "cassebrique" | "frogger" | "tapetaupe" | "sortemall" | "pacman" | "towerdefense" | "tycoon" | "chifoumirh";
  title: string;
  description: string;
  actionText: string;
...
const games: GameDef[] = [
  ...
  { id: "chifoumirh", title: "Chifoumi RH", description: "Confrontez Prévention, Accompagnement et Sanctions dans ce mini-jeu de prise de décision managériale.", actionText: "Défier", icon: Sparkles, iconTheme: "orange", bgImage: "roulette.png", spanClass: "col-span-1" },
...
const EspaceJeux: React.FC<EspaceJeuxProps> = ({ onClose, theme = 'dark' }) => {
  ...
  if (activeGame === "chifoumirh") return wrapGame(<ChifoumiRH onClose={() => setActiveGame("none")} />);
